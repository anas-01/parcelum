...
// Database
import Database_Parcelum_db from "./Database_Parcelum_db.js";

// Controllers
import UserController from "../controllers/Parcelum_db/UserController";
import CustomersController from "../controllers/Parcelum_db/CustomersController";
import ParcelsController from "../controllers/Parcelum_db/ParcelsController";
...
class Server {
 ...
 // End Init Database
    ...
    // Start Init Controllers
		...
		CustomersController.init(router);
		ParcelsController.init(router);
